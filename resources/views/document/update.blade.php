                    ...
                    <div class="row">
                        <div class="form-group">
                            ...
                            <select class="form-select form-select" name="category_id" id="category_id">
                                <option selected value="{{ $document->category->id }}">{{ $document->category->name }}
                                </option>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="description" id="description" rows="3"
                                placeholder="Masukkan keterangan atau deskripsi dokumen">{{ $document->description }}yyyyy</textarea>
                            @error('description')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <small class="fw-bold text-primary">Jangan input kan file dokumen jika tidak mengubah isi
                                file</small>
                            @error('file')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
